...
import { User, Mail, Phone, MapPin, Calendar, Edit3, Save, X, Camera, Shield, Bell, Globe, Heart, Star, Trophy, Clock, CreditCard, Lock, Eye, EyeOff, Key } from 'lucide-react';
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      if (data || meta?.success) {
        ...
        toast.error(meta?.message || 'Erreur lors du changement de mot de passe');
      }
    } catch (error: any) {
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-orange-600 to-orange-700 text-white px-4 py-3 rounded-lg hover:from-orange-700 hover:to-orange-800 transition-all flex items-center justify-center space-x-2"
              >
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md">
            ...
            <div className="p-6 bg-gray-50 rounded-b-xl flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg hover:from-orange-700 hover:to-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
              >
                {changingPassword ? (
                  <>
