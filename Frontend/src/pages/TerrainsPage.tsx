...
const TerrainsPage: React.FC = () => {
  ...
  return (
    <>
      <SEOMetaTags
        title="Terrains synthétiques disponibles au Sénégal"
        description="Parcourez la liste de tous les terrains synthétiques Kalél Sa Match : filtres par zone, prix, carte interactive et réservation en ligne."
        url="https://kalelsamatch.com/terrains"
      />
