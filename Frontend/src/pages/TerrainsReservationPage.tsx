...
const TerrainsReservationPage: React.FC = () => {
  ...
  if (loading) {
    return (
      <>
        <SEOMetaTags
          title="Réservation de terrains - Disponibilités en temps réel"
          description="Comparez les terrains synthétiques disponibles et réservez votre créneau en ligne avec Kalél Sa Match."
          url="https://kalelsamatch.com/terrains-reservation"
        />
  ...
  return (
    <>
      <SEOMetaTags
        title="Réserver un terrain synthétique en ligne"
        description="Filtrez par prix, notes ou proximité et réservez votre terrain synthétique préféré avec paiement mobile money."
        url="https://kalelsamatch.com/terrains-reservation"
      />
      <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
