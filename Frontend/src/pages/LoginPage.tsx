...
const LoginPage: React.FC = () => {
    ...
    if (isAuthenticated && user) {
      ...
      switch (user.role) {
        ...
        case 'gestionnaire':
          ...
          break;
        case 'client':
          redirectPath = '/dashboard/map';
          break;
        default:
          redirectPath = '/dashboard';
      }
      
      // Utiliser le chemin de redirection s'il provient d'une page protégée, sinon rediriger par rôle
      const targetPath = (from && from !== '/' && from !== '/login') ? from : redirectPath;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Tentative de connexion - Password:', password);
  ...
  return (
    <>
      <SEOMetaTags
        title="Connexion - Accédez à vos réservations"
        description="Connectez-vous à Kalél Sa Match pour gérer vos réservations, abonnements et paiements mobile money en toute sécurité."
