...
const ContactPage: React.FC = () => {
  return (
    <>
      <SEOMetaTags
        title="Contact - Kalél Sa Match"
        description="Contactez l'équipe Kalél Sa Match pour toute question sur les réservations, abonnements ou partenariats terrains au Sénégal."
        url="https://kalelsamatch.com/contact"
      />
