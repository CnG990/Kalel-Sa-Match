<?php
/**
 * Script de test pour l'API distante Kalel Sa Match sur Render
...
class APITester {
    ...
    private function makeRequest($endpoint, $method = 'GET', $data = null, $headers = []) {
        ...
        $defaultHeaders = [
            ...
            'User-Agent: Kalel-Sa-Match-API-Tester/1.0'
        ];
    ...
    public function runTests() {
        echo "🚀 Démarrage des tests de l'API Kalel Sa Match\n";
    ...
    private function generateReport() {
        ...
        if ($successfulTests === $totalTests) {
            ...
            echo "   ✅ La plupart des tests sont passés. L'API fonctionne bien.\n";
        } elseif ($successfulTests > ($totalTests * 0.5)) {
            echo "   ⚠️ Certains tests ont échoué. Vérifiez la configuration.\n";
        } else {
            echo "   ❌ Beaucoup de tests ont échoué. L'API a des problèmes.\n";
        }
