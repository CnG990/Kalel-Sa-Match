...
echo "=== GÉOLOCALISATION COMPLEXE SPORTIF PARCELLES ===\n\n";

$terrain = TerrainSynthetiquesDakar::where('nom', 'LIKE', '%Complexe Sportif Parcelles%')->first();
...
if ($terrain) {
    ...
    echo "Terrain Complexe Sportif Parcelles non trouvé dans la base de données.\n";
}
