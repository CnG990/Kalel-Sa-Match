...
class AboutScreen extends StatelessWidget {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Application de gestion de terrains synthétiques',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Kalél Sa Match Gestionnaire est une application mobile qui permet aux gestionnaires de terrains synthétiques de gérer leurs terrains, leurs réservations et leurs statistiques. L\'application offre une interface simple et intuitive pour gérer votre activité.',
                          style: Theme.of(context).textTheme.bodyMedium?.copyWith(
  ...
  Widget _buildTechItem(BuildContext context, String name, String description) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(Icons.code, color: Theme.of(context).colorScheme.secondary, size: 20),
